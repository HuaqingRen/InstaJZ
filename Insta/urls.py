...
from Insta.views import addLike,HelloWorldView, PostsView, PostDetailView, PostCreateView, PostUpdateView, PostDeleteView
from Insta.views import UserDetailView
